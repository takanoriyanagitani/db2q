...
use crate::db2q::proto::queue::v1::q_svc::PopFrontRequest;

pub struct PopFrontReq {
    request_id: Uuid,
    topic_id: Uuid,
}
...
impl TryFrom<PopFrontRequest> for PopFrontReq {
    type Error = Status;
    fn try_from(g: PopFrontRequest) -> Result<Self, Self::Error> {
